...
export default function ReservationCards() {
  return (
    <div className="h-[20rem] w-[22rem] relative lg:h-[17rem] lg:w-[19rem] my-2">
      ...
      <span className="font-semibold absolute top-2 left-3 z-10  text-green-500 ">
        <span className="text-gray-200">Status :</span> Accepted
      </span>
    <span className="font-semibold absolute top-8 text-gray-300 text-sm left-3 z-10 ">12/08/2035</span>
