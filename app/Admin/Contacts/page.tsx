...
import NewContacts from "@/components/Add/NewContacts";
import NewTrip from "@/components/Add/NewTrip";
import SearchBar from "@/components/SearchBar";
import { columns, Data } from "@/components/costumeInputs/ContactCol";
    ...
    <section className="bg-[#ebe9e9]">
      <header className="h-full w-full">
        <div className="w-full h-1/5  flex flex-col  justify-center items-start">
          <h1 className="text-gray-700 text-4xl font-bold px-5 py-5">Contacts</h1>
          <SearchBar
